...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    private boolean isShowIndicators = true;// 是否显示指示器
    private long releaseTime = 0; // 手指松开、页面不滚动时间，防止手机松开后短时间进行切换
    private int WHEEL = 100; // 转动
    private int WHEEL_WAIT = 101; // 等待
    private ImageCycleViewListener mImageCycleViewListener;
    private List<Adverts> infos;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(
                R.layout.view_cycle_viewpage, null);
    ...
    public void setData(List<ImageView> views, List<Adverts> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, List<Adverts> list, ImageCycleViewListener listener, int showPosition) {
    ...
    private void initIndicators(int ivSize) {
        // 设置指示器
        if (isShowIndicators) {
            ...
            for (int i = 0; i < indicators.length; i++) {
                View view = LayoutInflater.from(getActivity()).inflate(
                        R.layout.view_cycle_viewpage_indicator, null);
     ...
     * 是否显示指示器
     *
     * @param isShowIndicators
     */
    public void isShowIndicator(boolean isShowIndicators) {
        this.isShowIndicators = isShowIndicators;
    }
            ...
            if (mImageCycleViewListener != null) {
                v.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mImageCycleViewListener.onImageClick(infos.get(position), position, v);
                    }
                });
            }
            container.addView(v);
    ...
    private void setIndicator(int selectedPosition) {
        for (int i = 0; i < indicators.length; i++) {
            indicators[i]
                    .setBackgroundResource(R.mipmap.ic_point_normal);
        }
        if (indicators.length > selectedPosition)
            indicators[selectedPosition]
                    .setBackgroundResource(R.mipmap.ic_point_press);
    }
    ...
    public static interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        public void onImageClick(Adverts info, int postion, View imageView);
    }
}